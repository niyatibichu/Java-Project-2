...
public class UserDbAccess  implements UserDaoInterface {
	...
	public User getUser(String username, String password) {
		...
		try{
		loginUser=(User)getJdbcTemplate().queryForObject(loginQuery, new Object[]{username,password}, new UserRowMapper());
	...
	public User getUserID(String username) {
		...
		try{
			linkUserId=(User)getJdbcTemplate().queryForObject(loginQuery, new Object[]{username}, new UserIdMapper());
		}catch(EmptyResultDataAccessException e){
			System.out.println("Error"+e);
		}
		return linkUserId;
